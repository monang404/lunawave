...
function enterDiscoverSearchLoading(query) {
    _discoverSearchActive = true;
    _discoverSearchLastQuery = query;
...
function exitDiscoverSearchMode() {
    _discoverSearchActive = false;
    _discoverSearchLastQuery = "";
...
function renderDiscoverSearchResults(results) {
...
function handleDiscoverSearchError() {
