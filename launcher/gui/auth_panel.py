...
def handle_first_run(app_instance, base_dir, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border):
    password_file = base_dir / "cache" / "admin_password.txt"
    if not password_file.exists():
        _reset_password(app_instance, base_dir, True, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border)

def on_reset_password(app_instance, base_dir, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border):
    if not messagebox.askyesno("Reset Password", "Apakah Anda yakin ingin mereset password admin? Ini akan menimpa password yang ada."):
        return
    _reset_password(app_instance, base_dir, False, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border)

def _reset_password(app_instance, base_dir, is_first_run, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border):
    try:
        try:
        ...
        if is_first_run:
            app_instance.after(500, lambda: show_new_password_dialog(app_instance, raw_password, True, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border))
        else:
            show_new_password_dialog(app_instance, raw_password, False, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border)
...
def show_new_password_dialog(parent, raw_password, is_first_run, bg, bg_card, bg_surface, accent, text_1, text_2, text_3, red, green, border):
