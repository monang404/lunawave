"""
Module: tests.unit.automation.test_find_owner_and_context_pack
...
Depends on:
    - automation.find_owner
    - automation.context_pack
...
class TestFindOwnerResolution:
    def test_resolves_by_file_path(self, fake_repo):
        import automation.find_owner as fo
...
class TestContextPackResolution:
    def test_class_name_query_returns_same_deps_as_file_path_query(self, fake_repo):
        ...
        import automation.context_pack as cp
