...
async def test_get_random_songs_with_data(memory_db):
    ...
    await memory_db.execute("INSERT INTO songs (youtube_id, judul, artist_id, duration) VALUES ('v1', 'Song 1', 1, 100)")
    await memory_db.execute("INSERT INTO songs (youtube_id, judul, artist_id, duration) VALUES ('v2', 'Song 2', 1, 110)")
    await memory_db.execute("INSERT INTO songs (youtube_id, judul, artist_id, duration) VALUES ('v3', 'Song 3', 2, 120)")
