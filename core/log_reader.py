"""
Module: core.log_reader

Purpose:
    Provide utilities to parse and tail lunawave.log files for dashboard and
...
def _get_all_lines() -> list[str]:
    """Reads lunawave.log and its backups in chronological order."""
