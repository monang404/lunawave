...
write_test('tests/unit/server/handlers/test_ws_playback.py', '''\
import pytest
from unittest.mock import AsyncMock, patch
...
write_test('tests/unit/server/handlers/test_ws_queue.py', '''\
import pytest
from unittest.mock import AsyncMock, patch
...
write_test('tests/unit/server/handlers/test_ws_discovery.py', '''\
import pytest
from unittest.mock import AsyncMock, patch
...
write_test('tests/unit/server/handlers/test_ws_download.py', '''\
import pytest
from unittest.mock import AsyncMock, patch
...
write_test('tests/unit/server/services/test_broadcast_service.py', '''\
import pytest
...
write_test('tests/unit/server/services/test_stream_prefetch.py', '''\
import pytest
...
write_test('tests/unit/plugins/test_lyrics_fetcher.py', '''\
import pytest
from unittest.mock import AsyncMock, patch
...
write_test('tests/unit/plugins/test_sponsorblock.py', '''\
import pytest
...
write_test('tests/unit/launcher/test_process.py', '''\
import pytest
...
write_test('tests/unit/launcher/test_network.py', '''\
import pytest
...
write_test('tests/unit/launcher/test_updater.py', '''\
import pytest
...
write_test('tests/unit/launcher/gui/test_status_panel.py', '''\
import pytest
...
write_test('tests/unit/launcher/gui/test_log_panel.py', '''\
import pytest
...
write_test('tests/unit/scripts/test_export_to_sqlite.py', '''\
import pytest
