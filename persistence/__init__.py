...
class Database:
    ...
    async def update_stream_url_only(self, *a, **kw): return await self._tracks.update_stream_url_only(*a, **kw)
    ...
    async def toggle_favorite(self, *a, **kw): return await self._tracks.toggle_favorite(*a, **kw)

    async def create_session(self, *a, **kw): return await self._sessions.create_session(*a, **kw)
    async def verify_session(self, *a, **kw): return await self._sessions.verify_session(*a, **kw)
    async def delete_session(self, *a, **kw): return await self._sessions.delete_session(*a, **kw)
    async def cleanup_sessions(self, *a, **kw): return await self._sessions.cleanup_sessions(*a, **kw)

    async def increment_artist_click(self, *a, **kw): return await self._artists.increment_artist_click(*a, **kw)
    async def get_all_artists(self, *a, **kw): return await self._artists.get_all_artists(*a, **kw)
    async def get_artist_songs_strict(self, *a, **kw): return await self._artists.get_artist_songs_strict(*a, **kw)

    async def increment_genre_click(self, *a, **kw): return await self._genres.increment_genre_click(*a, **kw)
    async def get_genre_artists(self, *a, **kw): return await self._genres.get_genre_artists(*a, **kw)
    async def get_genre_songs(self, *a, **kw): return await self._genres.get_genre_songs(*a, **kw)

    async def get_random_songs(self, *a, **kw): return await self._library.get_random_songs(*a, **kw)
