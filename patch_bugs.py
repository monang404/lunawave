...
# ─── PATCH 7 ─────────────────────────────────────────────────────────────────
# Windows: MPV TCP connection timing — flat sleep(1.0) → polling loop
# Root cause: MPV butuh > 1 detik siap di Windows, koneksi gagal semua attempt
patch(
    ...
    "PATCH 7: mpv_controller.py — Windows TCP polling loop (fix MPV connect timeout)"
)